...
namespace DripDemo1.Tests.ServiceLayerTest
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var webServiceRequest = new Business.CreateResponseObject.Communications(new Business.CreateResponseObject.Transaction.WebServiceTransaction()).WebServiceCall(keyValue);
